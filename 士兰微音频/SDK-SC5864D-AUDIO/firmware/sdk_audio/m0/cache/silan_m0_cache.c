...
static void cache_area_sel(uint32_t cache_area)
{
...
static uint32_t cache_load_code(uint32_t addr, uint32_t len)
{
...
static uint32_t cache_lock_code(uint32_t addr, uint32_t len)
{
	spicache_st->opaddr = addr;
	spicache_st->opsize = len;
...
void cache_unlock_code(uint32_t addr, uint32_t len,uint8_t need_cache_unvalid)
{
	spicache_st->opaddr = addr;
	spicache_st->opsize = len;
