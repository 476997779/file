...
typedef struct _DFU_MAL_PROP
{
  ...
  uint16_t (*pMAL_Write)    (uint8_t *Buf, uint32_t Add, uint32_t Len);
  uint16_t (*pMAL_Read)     (uint8_t *Buf, uint32_t Add, uint32_t Len);
...
uint16_t MAL_Write (uint8_t *Buf, uint32_t SectorAddress, uint32_t DataLength);
uint16_t MAL_Read  (uint8_t *Buf, uint32_t SectorAddress, uint32_t DataLength);
